...
%% Keypoints Detection
tic,keypoints_1 = Detect_Keypoint(I1,r1,radius,N,nOctaves1,G_resize,key_type);
...
tic,keypoints_2 = Detect_Keypoint(I2,r2,radius,N,nOctaves2,G_resize,key_type);
...
switch output_form
    case 'Reference'
        [I2_r,I2_rs,I3,I4] = Transformation_ref...
            (image_1,image_2,cor1,cor2,trans_form);
    case 'Union'
        [I1_r,I2_r,I1_rs,I2_rs,I3,I4] = Transformation_union...
            (image_1,image_2,cor1,cor2,trans_form);
    case 'Inter'
        [I1_r,I2_r,I1_rs,I2_rs,I3,I4] = Transformation_inter...
            (image_1,image_2,cor1,cor2,trans_form);
end
