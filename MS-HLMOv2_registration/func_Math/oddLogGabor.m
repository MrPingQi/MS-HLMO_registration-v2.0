...
function EO = oddLogGabor(img, nscale, norient, minWaveLength, mult, sigmaf)
% default parameters:
...
[x,y] = meshgrid(xrange, yrange); clear xrange; clear yrange;
radius = sqrt(x.^2 + y.^2);
theta = atan2(-y,x); clear x; clear y;
