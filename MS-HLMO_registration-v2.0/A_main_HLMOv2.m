...
tic,keypoints_1 = Detect_Keypoint(I1,6,thresh,r1,Npoint,nOctaves1,G_resize,key_type,1);
    t(1)=toc; fprintf(['已完成参考图像特征点检测，用时 ',num2str(t(1)),'s\n']);
              fprintf([' Done keypoints detection of reference image, time: ',num2str(t(1)),'s\n']);
tic,keypoints_2 = Detect_Keypoint(I2,6,thresh,r2,Npoint,nOctaves2,G_resize,key_type,1);
